...
public class TestTargetSystemExtension implements TargetSystemExtensionFactory {

	private Logger logger = LogManager.getLogger(TestTargetSystemExtension.class.getName());
	
	public TestTargetSystemExtension() { }
	
	@Override 
	public TargetSystemExtensionDao getTargetSystemExtension(StatusMessenger aStatusMessenger) {
		logger.trace("getTargetSystemExtension(): aStatusMessenger = {}", aStatusMessenger);
		
		if(aStatusMessenger == null) throw new IllegalArgumentException("aStatusMessenger can't be null");
		
		return new TargetSystemExtensionDao(null, null, null); 
