...
class Z80TrainerProtocolTest {
	...
	void testToString() {
		...
		assertEquals(
			  ...
			  + "], "
			  + "encoder=Encoder ["
			  + "silenceEncoder=SilenceEncoder ["
			  + "samplingRate=9088"
			  + "], "
			  + "waveCycleEncoder=WaveCycle ["
			  + "samplingRate=9088"
			  + "], "
			  + "bitEncoder=FskBitEncoder ["
			  + "lowBitFrequency=568, "
			  + "highBitFrequency=1136"
			  + "], "
			  + "startBitSamples=java.nio.HeapByteBuffer["
			  + "pos=16 lim=16 cap=16"
			  + "], "
			  + "stopBitSamples=java.nio.HeapByteBuffer["
			  + "pos=24 lim=24 cap=24"
			  + "], "
			  + "sampleBuffer=null, "
			  + "bitOrder=LSB_MSB, "
