...
/**
 * Responsibilities:<br>
 * Defines the interface of Reader Extension Factories
 * 
 * <p>
 * Collaborators:<br>
 * None.
...
public interface InputReaderExtensionFactory {
	 ...
	 * 
	 * @return InputReaderExtensionDao
	 * A DAO holding references to the extension components.
	 * <br>
	 * Please refer to {@link extension.model.InputReaderExtensionDao} for more and detailed information 
	 ...
	 * 
	 */
	InputReaderExtensionDao getInputReaderExtensions(StatusMessenger aStatusMessenger) throws Exception;
