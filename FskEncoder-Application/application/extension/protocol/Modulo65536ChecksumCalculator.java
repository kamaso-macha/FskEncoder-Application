...
public class Modulo65536ChecksumCalculator extends ChecksumCalculator {

	private Logger logger = LogManager.getLogger(Modulo65536ChecksumCalculator.class.getName());
	
	/**
	 * Constructor who initializes the superclass with the mask to be applied.
	 */
	public Modulo65536ChecksumCalculator() {
		super(0x00FFFF);
		
		logger.trace("Modulo65536ChecksumCalculator()");
