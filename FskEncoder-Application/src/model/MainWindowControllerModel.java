 ...
 * FILENAME      : MainWindowControllerModel.java
 *
...
// DOC
// Created at 2024-06-05 09:52:21

public interface MainWindowControllerModel {
	
	boolean getAutosaveFlag();
	Point getCurrentPosition();
	String getTargetSystemName();
	void saveSetings();
	void setAutosaveFlag(Boolean aState);
	void setCurrentPosition(Point aLocation);
