...
public class Z80TrainerTermIOSExtension implements TargetSystemExtensionFactory {
	
	private Logger logger = LogManager.getLogger(Z80TrainerTermIOSExtension.class.getName());
	...
	public TargetSystemExtensionDao getTargetSystemExtension(StatusMessenger aStatusMessenger) {
		...
		Z80TrainerTermIOSExtensionControl control = new Z80TrainerTermIOSExtensionControl(aStatusMessenger);
