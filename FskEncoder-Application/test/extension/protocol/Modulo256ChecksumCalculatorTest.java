 ...
 * **********************************************************************
 * PROJECT       : FskEncoder
 * FILENAME      : Z80TChecksumCalculatorTest.java
 *
 ...
 * 
 * The CUT has a constructor with NO parameters because it is fixed to a specific mask
 * and applies a strict MOD 256 algorithm.
 * 
 * <p>
 * @author Stefan
 *
...
class Modulo256ChecksumCalculatorTest {
	...
	/**
	 * Test method for {@link extension.protocol.Modulo256ChecksumCalculator#sumUp(int)}.
	 */
	@Test
	public void testSumUp_CorrectMasking() {
		LOGGER.info("testSumUp_CorrectMasking()");
		
		Modulo256ChecksumCalculator cut = new Modulo256ChecksumCalculator();
